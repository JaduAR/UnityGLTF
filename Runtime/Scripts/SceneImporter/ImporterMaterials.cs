		...
		protected virtual async Task ConstructMaterial(GLTFMaterial def, int materialIndex)
		{
			...
			if (def.PbrMetallicRoughness != null && mrMapper != null)
			{
				...
				if (pbr.BaseColorTexture != null)
				{
					...
					await ConstructTexture(textureId.Value, textureId.Id, !KeepCPUCopyOfTexture, false, CompressTextures, false);
				...
				if (pbr.MetallicRoughnessTexture != null)
				{
					...
					await ConstructTexture(textureId.Value, textureId.Id, !KeepCPUCopyOfTexture, true, CompressTextures, false);
			...
			if (uniformMapper != null)
			{
				if (def.NormalTexture != null)
				{
					...
					await ConstructTexture(textureId.Value, textureId.Id, !KeepCPUCopyOfTexture, true, CompressTextures, true);
